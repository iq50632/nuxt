<template>
  <div style="background: rgb(255, 255, 255, 0.7);">
    <div>
      ...
      <div class="my-4">
        <div class="container">
          <p class="title pb-4 d-flex align-items-center" style="border-bottom: 3px solid rgb(111, 197, 247);">
            <img src="~/assets/image/dabe_blue.png" style="width:50px;height:50px" alt="" class="ml-2 mr-3">熱銷排行</p>
        </div>
        <swiper :auto-update="true" ref="mySwiper" :options="swiperProduct" style="height: 370px;overflow: hidden;">
          <swiper-slide v-for="i in product" :key="i.id" style="width:auto" class="ml-3">
            <nuxt-link class="text-dark" style="text-decoration:none;"
              :to="{ name: 'product-id', params: { id: i.id } }">
              <div class="cardSelect" style="width:250px">
                <div class="imgFrame">
                  <img :src="i.img" alt="" class="m-auto">
                </div>
                <h3 class="my-3" style="text-overflow:ellipsis;">{{i.name}}</h3>
                <div class="d-flex justify-content-between">
                  <span style="border-bottom: 3px solid rgb(23, 162, 184); width: 50px">
      ...
      <div class="container shadow p-5 my-5 bg-body rounded" style="">
        <p class="title pb-4 d-flex align-items-center" style="border-bottom: 4px solid rgb(111, 197, 247);">
          <img src="~/assets/image/dabe_blue.png" style="width:50px;height:50px" alt="" class="ml-2 mr-3">新品上市</p>
        <div class="container" style="">
          <div class="m-auto row">
            <nuxt-link class="text-dark col-12 col-lg-3 col-md-6 col-sm-12 p-4" style="text-decoration:none;"
              v-for="i in product" :key="i.id" :to="{ name: 'product-id', params: { id: i.id } }">
              <div class="cardSelect_blue row">
                <div class="imgFrame col-3 col-lg-12 col-sm-3 col-md-12">
                  <img :src="i.img" alt="" class="m-auto">
                </div>
                <div class=" col-9 col-lg-12 col-sm-9 col-md-12">
                  <h3 class="my-3" style="text-overflow:ellipsis;">{{i.name}}</h3>
                  <div class="d-flex justify-content-between">
                    <span style="border-bottom: 3px solid rgb(23, 162, 184); width: 50px">
                      <p class="mb-n5">${{i.price}}</p>
        ...
        <div class="text-center">
          <nuxt-link class="btn text-light" style="background-color:rgb(111, 197, 247)" to="/product/main">看更多
          </nuxt-link>
        </div>
    </div>
    </div>
